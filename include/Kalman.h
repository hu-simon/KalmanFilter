...
class BasicKalmanFilter {
  ...
  public:
    ...
    void update(const Eigen::MatrixXd &C, const Eigen::VectorXd &y, double dt);
...
/* TO IMPLEMENT */
/*
 * This one might be a little more tricky to complete since we need some way to
 * evaluate the motion model and the observation model.
 */
